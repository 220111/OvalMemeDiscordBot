    ...
    if(arg[0] == suf || arg[0] == sufC){
        ...
        || arg[1] == "g" || arg[1] == "get"){
            if(arg[2]){
              ...
              if(arg[2] == "dankmemes" || arg[2] == "pewdiepiesubmissions"){
                ...
                message.channel.sendMessage('That reddit server is not currently enabled!');
                message.channel.sendMessage('Please contact an admin to assist you');
              }
            ...
            if(server.currentPage != null){
                if(server.currentPage.hasOwnProperty("data")){
                    ...
                    rndcnt = rndcnt + 1
                    if (rndcnt == 10){
                      message.channel.sendMessage('Changing pages');
                      message.channel.sendMessage('oval next')
                      rndcnt = 0
                    }
                    console.log(rndcnt);
                }
        ...
        else if(arg[1] == "how" && arg[2] == "are" && arg[3] == "you"){
          if (how == 1){
            message.channel.sendMessage('I am good. How about you?');
          }
          if (how == 2){
            message.channel.sendMessage('None of your buissness');
          }
          if (how == 3){
            message.channel.sendMessage('Im hungry');
          }
          if (how == 4){
            message.channel.sendMessage('Im feeling pretty sexy right now');
          }
          if (how == 5){
            message.channel.sendMessage('   ');
          }
          if (how == 6){
            message.channel.sendMessage('Um I do not know');
          }
          if (how == 7){
            message.channel.sendMessage('https://www.youtube.com/watch?v=NyhT6YkMn1E');
          }
          if (how == 8){
            message.channel.sendMessage('https://www.cnbc.com/2019/03/07/stop-asking-how-are-you-harvard-researchers-say-this-is-how-successful-people-make-small-talk.html');
          }
          if (how == 9){
            message.channel.sendMessage('Now searching for how are you on reddit');
          }
          else {
